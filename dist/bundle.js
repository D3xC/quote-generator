...
var vm = new _vue2.default({
  ...
  methods: {
    ...
    tweetQuote: function tweetQuote() {
      window.open('https://twitter.com/intent/tweet?hashtags=quotes&related=freecodecamp&text=' + encodeURIComponent('"' + this.quote + '" ' + this.author));
    }
  }
});
